                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('clientes::ncfs::divisas::nuevo') }}" id="form_consulta">
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                {{ csrf_field() }}
                                <button type="submit" class="btn btn-danger btn-sm" id="btn_submit" data-loading-text="Buscando transacciones..." style="margin-top: 27px;">Buscar Transacciones</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <a class="btn btn-danger pull-right btn-xs" href="{{ route('clientes::ncfs::divisas::eliminar_todo') }}" data-toggle="tooltip" data-placement="top" title="Eliminar Todo" style="margin-top: -3px;color: #FFFFFF;">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <a class="btn btn-success btn-sm pull-right" href="{{ route('clientes::ncfs::divisas::guardar') }}">Guardar NCF (Divisas)</a>
                            </div>
                        </div>
