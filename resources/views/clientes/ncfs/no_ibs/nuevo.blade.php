            ...
            <div class="panel-body">
                <form method="post" action="{{ route('clientes::ncfs::no_ibs::nuevo') }}" id="form_consulta">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            {{ csrf_field() }}
                            <a href="{{ route('clientes::ncfs::consulta') }}" class="btn btn-default">Cancelar</a>
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <a class="btn btn-warning pull-right btn-xs" href="{{ route('clientes::ncfs::no_ibs::eliminar_todo') }}" data-toggle="tooltip" data-placement="top" title="Eliminar Todo" style="margin-top: -3px;">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-2">
                            <a class="btn btn-danger" href="{{ route('clientes::ncfs::no_ibs::detalle::nuevo') }}">Agregar Transacción</a>
                        </div>
                        <div class="col-xs-3">
                        ...
                        <div class="col-xs-2">
                            <a class="btn btn-success pull-right" href="{{ route('clientes::ncfs::no_ibs::guardar') }}">Guardar NCF (No IBS)</a>
                        </div>
                    </div>
