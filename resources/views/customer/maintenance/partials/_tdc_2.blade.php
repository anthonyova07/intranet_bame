        ...
        <div class="panel-body">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('building_name_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="30" name="building_name_2_itc" value="{{ old('building_name_2_itc') ? old('building_name_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getBuildingName() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('block_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="10" name="block_2_itc" value="{{ old('block_2_itc') ? old('block_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getBlock() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('house_number_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="10" name="house_number_2_itc" value="{{ old('house_number_2_itc') ? old('house_number_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getHouseNumber() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('km_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="km_2_itc" value="{{ old('km_2_itc') ? old('km_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getKm() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('postal_zone_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="10" name="postal_zone_2_itc" value="{{ old('postal_zone_2_itc') ? old('postal_zone_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getPostalZone() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('postal_mail_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="10" name="postal_mail_2_itc" value="{{ old('postal_mail_2_itc') ? old('postal_mail_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getPostalMail() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('in_street_1_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="in_street_1_2_itc" value="{{ old('in_street_1_2_itc') ? old('in_street_1_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getInStreet1() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('in_street_2_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="in_street_2_2_itc" value="{{ old('in_street_2_2_itc') ? old('in_street_2_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getInStreet2() : '') }}">
            ...
            <div class="col-xs-12">
                <div class="form-group{{ $errors->first('special_instruction_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="60" name="special_instruction_2_itc" value="{{ old('special_instruction_2_itc') ? old('special_instruction_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getSpecialInstruction() : '') }}">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4">
                <div class="form-group{{ $errors->first('main_phone_area_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="3" name="main_phone_area_2_itc" value="{{ old('main_phone_area_2_itc') ? old('main_phone_area_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getMainPhoneArea() : '') }}">
            ...
            <div class="col-xs-4">
                <div class="form-group{{ $errors->first('main_phone_number_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="main_phone_number_2_itc" value="{{ old('main_phone_number_2_itc') ? old('main_phone_number_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getMainPhoneNumber() : '') }}">
            ...
            <div class="col-xs-4">
                <div class="form-group{{ $errors->first('main_phone_ext_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="4" name="main_phone_ext_2_itc" value="{{ old('main_phone_ext_2_itc') ? old('main_phone_ext_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getMainPhoneExt() : '') }}">
            ...
            <div class="col-xs-4">
                <div class="form-group{{ $errors->first('secundary_phone_area_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="3" name="secundary_phone_area_2_itc" value="{{ old('secundary_phone_area_2_itc') ? old('secundary_phone_area_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getSecundaryPhoneArea() : '') }}">
            ...
            <div class="col-xs-4">
                <div class="form-group{{ $errors->first('secundary_phone_number_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="secundary_phone_number_2_itc" value="{{ old('secundary_phone_number_2_itc') ? old('secundary_phone_number_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getSecundaryPhoneNumber() : '') }}">
            ...
            <div class="col-xs-4">
                <div class="form-group{{ $errors->first('secundary_phone_ext_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="4" name="secundary_phone_ext_2_itc" value="{{ old('secundary_phone_ext_2_itc') ? old('secundary_phone_ext_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getSecundaryPhoneExt() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('main_cell_area_2_itc') ? ' has-error':'' }}">
                    <label class="control-label">Teléfono Principal Área</label>
                    <input type="text" class="form-control input-sm" maxlength="3" name="main_cell_area_2_itc" value="{{ old('main_cell_area_2_itc') ? old('main_cell_area_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getMainCellArea() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('main_cell_number_2_itc') ? ' has-error':'' }}">
                    <label class="control-label">Teléfono Principal Núm.</label>
                    <input type="text" class="form-control input-sm" maxlength="7" name="main_cell_number_2_itc" value="{{ old('main_cell_number_2_itc') ? old('main_cell_number_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getMainCellNumber() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('secundary_cell_area_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="3" name="secundary_cell_area_2_itc" value="{{ old('secundary_cell_area_2_itc') ? old('secundary_cell_area_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getSecundaryCellArea() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('secundary_cell_number_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="secundary_cell_number_2_itc" value="{{ old('secundary_cell_number_2_itc') ? old('secundary_cell_number_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getSecundaryCellNumber() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('fax_area_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="3" name="fax_area_2_itc" value="{{ old('fax_area_2_itc') ? old('fax_area_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getFaxArea() : '') }}">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->first('fax_number_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="7" name="fax_number_2_itc" value="{{ old('fax_number_2_itc') ? old('fax_number_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getFaxNumber() : '') }}">
            ...
            <div class="col-xs-12">
                <div class="form-group{{ $errors->first('mail_2_itc') ? ' has-error':'' }}">
                    ...
                    <input type="text" class="form-control input-sm" maxlength="50" name="mail_2_itc" value="{{ old('mail_2_itc') ? old('mail_2_itc') : ($customer->actives_creditcards->get($tdc)->address_two ? $customer->actives_creditcards->get($tdc)->address_two->getMail() : '') }}">
