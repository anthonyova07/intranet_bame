...
<html>
<head>
    <title>{{ $requests_tdc->count() }} Solicitudes Impresas</title>
    <style>
        body {
            font-family: 'Juhl';
            color: #616365;
            ...
            <table style="font-size: 100%;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table_td" colspan="1"><b>Dirección Entrega:</b> {{ $request_tdc->senddirpla == 'personal' ? 'Personal' : 'Laboral' }}</td>
                    </tr>
                </tbody>
            </table>
