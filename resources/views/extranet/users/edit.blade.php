...
@section('page_title', 'Editar Usuario Extranet')
        ...
        <div class="col-xs-10 col-xs-offset-1">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form method="post" action="{{ route('extranet.users.update', $user->id) }}" id="form">
                        <div class="row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group{{ $errors->first('full_name') ? ' has-error':'' }}">
                                    ...
                                    <input type="text" class="form-control input-sm" name="full_name" value="{{ $user->full_name }}">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group{{ $errors->first('identification') ? ' has-error':'' }}">
                                    ...
                                    <input type="text" class="form-control input-sm" name="identification" value="{{ $user->identifica }}">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group{{ $errors->first('position') ? ' has-error':'' }}">
                                    ...
                                    <input type="text" class="form-control input-sm" name="position" value="{{ $user->position }}">
