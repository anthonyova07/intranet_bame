        ...
        <div class="col-xs-8 col-xs-offset-2">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form method="post" action="{{ route('mercadeo::coco::mantenimiento') }}" id="form_encarte">
                        <div class="row">
                            <div class="col-xs-10">
                                <div class="form-group{{ $errors->first('title') ? ' has-error':'' }}">
                                    <label class="control-label">Título</label>
                                    <input type="text" class="form-control" name="title" value="{{ $coco->get()->title }}">
                        ...
                        <div class="form-group{{ $errors->first('descriptions') ? ' has-error':'' }}">
                            ...
                            <textarea class="form-control" name="descriptions" rows="5">@foreach ($coco->get()->descriptions as $description){{ $description->order . '-' . $description->description . chr(13) . chr(10) }}@endforeach</textarea>
                        ...
                        <div class="form-group{{ $errors->first('awards') ? ' has-error':'' }}">
                            ...
                            <textarea class="form-control" name="awards" rows="5">@foreach ($coco->get()->awards as $award){{ $award->order . '-' . $award->award . chr(13) . chr(10) }}@endforeach</textarea>
