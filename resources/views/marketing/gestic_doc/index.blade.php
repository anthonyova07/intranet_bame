...
@section('page_title', 'Mantenimiento GesticDoc')
        ...
        <div class="col-xs-6 col-xs-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('marketing.gesticdoc.store') }}" id="form" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group{{ $errors->first('term') ? ' has-error':'' }}">
                                    <label class="control-label">Archivos</label>
                                    <input type="file" class="form-control input-sm" name="files[]" multiple>
                            ...
                            @foreach ($files as $file)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;text-align: center;font-size: 20px;">
                                        ...
                                        <form
                                            action="{{ route('marketing.gesticdoc.destroy', ['file' => $file->file]) }}"
