                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <div class="form-group{{ $errors->first('image') ? ' has-error':'' }}">
                                    ...
                                    <input type="text" class="form-control input-sm" name="image" maxlength="150" value="{{ $gallery->image  }}">
                            ...
                            <div class="col-xs-5">
                                <div class="form-group{{ $errors->first('galdate') ? ' has-error':'' }}">
                                    ...
                                    <input type="date" class="form-control input-sm" name="galdate" value="{{ $gallery->galdate->format('Y-m-d') }}">
