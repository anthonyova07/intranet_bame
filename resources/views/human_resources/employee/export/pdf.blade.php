            ...
            <tbody>
                <tr valign="top">
                    ...
                    <td align="right" width="408">
                        <b style="font-size: 14px;font-style: italic;">Reporte de Empleados</b>
                    </td>
                </tr>
                <tr align="right">
                    <td>
        ...
        <table style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th valign="bottom" style="">Identificación</th>
            ...
            <tbody>
                @foreach ($employees as $employee)
                    <tr>
                        ...
                        <td align="center" style="border-bottom: 1px solid #CCCCCC;">{{ $employee->name }}</td>
                        <td align="center" style="border-bottom: 1px solid #CCCCCC;">{{ $employee->identifica }}</td>
                        <td align="center" style="border-bottom: 1px solid #CCCCCC;">{{ $employee->mail }}</td>
                        <td align="center" style="border-bottom: 1px solid #CCCCCC;">{{ $employee->position->name }}</td>
                        <td align="center" style="border-bottom: 1px solid #CCCCCC;">{{ $employee->supervisor ? $employee->supervisor->name : '' }}</td>
                        ...
                        <td align="center" style="border-bottom: 1px solid #CCCCCC;">{{ get_gender($employee->gender) }}</td>
