@if (!can_not_do('human_resource_request') && $human_resource_request->rhverified)
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="form-group{{ $errors->first('client_number') ? ' has-error':'' }}">
                                ...
                                <input type="text" disabled class="form-control input-sm" name="client_number" value="{{ $human_resource_request->detail->clientnum }}">
                        ...
                        <div class="col-xs-4">
                            <div class="form-group{{ $errors->first('ant_deposit_date') ? ' has-error':'' }}">
                                ...
                                <input type="date" disabled class="form-control input-sm" name="ant_deposit_date" value="{{ $human_resource_request->detail->advdatdepo }}">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group{{ $errors->first('ant_first_due_date') ? ' has-error':'' }}">
                                ...
                                <input type="date" disabled class="form-control input-sm" name="ant_first_due_date" value="{{ $human_resource_request->detail->firsduedat }}">
