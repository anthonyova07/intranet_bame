<form method="post" action="hola">
    ...
    <div class="row">
        <div class="col-xs-6 col-xs-offset-3">
            <textarea style="margin-top: -15px;margin-bottom: 20px;" class="form-control input-sm" placeholder="Especifique la razón del reintegro..." name="per_reason_reintregrate">{{ old('per_reason_reintregrate') ? old('per_reason_reintregrate') : $human_resource_request->detail->observar }}</textarea>
        </div>
    </div>
    <div class="row">
