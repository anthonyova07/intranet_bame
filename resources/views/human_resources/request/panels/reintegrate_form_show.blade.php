                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <input type="date" style="width: 135px;" disabled class="form-control input-sm" name="permission_date_reintegrate" value="{{ $human_resource_request->detail->pertype == 'one_day' && $human_resource_request->detail->perdatfror ? $human_resource_request->detail->perdatfror->format('Y-m-d') : '' }}">
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="form-group">
