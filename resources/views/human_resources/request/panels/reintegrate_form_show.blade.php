                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="form-group{{ $errors->first('permission_time_to_reintegrate') ? ' has-error':'' }}">
                            ...
                            <input type="time" disabled class="form-control input-sm" name="permission_time_to_reintegrate" value="{{ old('permission_time_to_reintegrate') ? old('permission_time_to_reintegrate') : $human_resource_request->detail->pertimtor }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group{{ $errors->first('permission_date_to_reintegrate') ? ' has-error':'' }}">
                                ...
                                <input type="date" disabled class="form-control input-sm" name="permission_date_to_reintegrate" value="{{ old('permission_date_to_reintegrate') ? old('permission_date_to_reintegrate') : ($human_resource_request->detail->perdatfror ? $human_resource_request->detail->perdatfror->format('Y-m-d') : '') }}">
    ...
    <div class="row">
        <div class="col-xs-6 col-xs-offset-3">
            <div class="form-group{{ $errors->first('per_reason_reintregrate') ? ' has-error':'' }}">
                <textarea disabled style="margin-top: -15px;" class="form-control input-sm" placeholder="Especifique la razón del reintegro..." name="per_reason_reintregrate">{{ old('per_reason_reintregrate') ? old('per_reason_reintregrate') : $human_resource_request->detail->observar }}</textarea>
