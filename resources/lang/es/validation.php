...
return [
    ...
    'attributes' => [
      ...
      'loss_type' => 'Tipo de Perdida',
      'risk_link' => 'Riesgo Vinculado',
      'risk_factor' => 'Factor de Riesgo',
      'event_start' => 'Fecha de Inicio del Evento',
      'event_end' => 'Fecha de Finalización del Evento',
      'event_disc' => 'Fecha Descubrimiento del Evento',
      'post_date' => 'Fecha de Contabilización',
      'account' => 'Cuenta Contable',
      'amount_nac' => 'Monto Perdida RD$',
      'amount_ori' => 'Monto Perdida Moneda Origen',
      'amount_ins' => 'Monto Recuperado por Seguro',
      'amount_rec' => 'Monto Recuperado',
    ],
];
