CREATE TABLE INTRANET_CLAIMS (
    ...
    RESPONSE_PLACE_CODE VARCHAR(45),
    RESPONSE_PLACE_DESCRIPTION VARCHAR(255),
    RESPONSE_DATE DATE,
    ...
    PRODUCT_SERVICE_CODE VARCHAR(45),
    PRODUCT_SERVICE_DESCRIPTION VARCHAR(255),

    KIND_PERSON_CODE VARCHAR(45),
    KIND_PERSON_DESCRIPTION VARCHAR(255),

    DISTRIBUTION_CHANNEL_CODE VARCHAR(45),
