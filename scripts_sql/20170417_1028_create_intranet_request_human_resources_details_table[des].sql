CREATE TABLE INTREQRHDE (
    ...
    CARPACKAGE VARCHAR(100), -- TIPO DE PAQUETE
    CAREDOACCO CHAR(1), -- SI LLEVA ESTADO DE CUENTA
    CAREDOPERI VARCHAR(100), -- PERIODO ESTADO DE CUENTA
    CARMODRETI VARCHAR(100), -- modo de retiro
